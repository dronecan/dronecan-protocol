// dc_pkt_sys.h was generated by ProtoGen version 2.3.b
...
//! return the minimum encoded length for the DC_Sys_DeviceId packet
#define getDC_Sys_DeviceIdMinDataLength() (7)

//! return the maximum encoded length for the DC_Sys_DeviceId packet
...
//! return the minimum encoded length for the DC_Sys_FirmwareInfo packet
#define getDC_Sys_FirmwareInfoMinDataLength() (8)

//! return the maximum encoded length for the DC_Sys_FirmwareInfo packet
...
//! return the minimum encoded length for the DC_Sys_RevisionDate packet
#define getDC_Sys_RevisionDateMinDataLength() (4)

//! return the maximum encoded length for the DC_Sys_RevisionDate packet
...
//! return the minimum encoded length for the DC_Sys_CPUInfo packet
#define getDC_Sys_CPUInfoMinDataLength() (6)

//! return the maximum encoded length for the DC_Sys_CPUInfo packet
...
//! return the minimum encoded length for the DC_Sys_SystemCommand packet
#define getDC_Sys_SystemCommandMinDataLength() (8)

//! return the maximum encoded length for the DC_Sys_SystemCommand packet
...
//! return the minimum encoded length for the DC_Sys_AssignNodeID packet
#define getDC_Sys_AssignNodeIDMinDataLength() (8)

//! return the maximum encoded length for the DC_Sys_AssignNodeID packet
